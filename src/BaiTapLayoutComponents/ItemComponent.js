                        ...
                        <div className="row gx-lg-5">
                            <div className="col-lg-6 col-xxl-4 mb-5">
                                <div className="card bg-light border-0 h-100">
                                    <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0 intro">
                                        <div className="feature bg-primary bg-gradient text-white rounded-3 mb-4 mt-n4 img"><i className="bi bi-collection" /></div>
                            ...
                            <div className="col-lg-6 col-xxl-4 mb-5">
                                <div className="card bg-light border-0 h-100">
                                    <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0 intro">
                                        <div className="feature bg-primary bg-gradient text-white rounded-3 mb-4 mt-n4 img"><i className="bi bi-cloud-download" /></div>
                            ...
                            <div className="col-lg-6 col-xxl-4 mb-5">
                                <div className="card bg-light border-0 h-100">
                                    <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0 intro">
                                        <div className="feature bg-primary bg-gradient text-white rounded-3 mb-4 mt-n4 img"><i className="bi bi-card-heading" /></div>
                            ...
                            <div className="col-lg-6 col-xxl-4 mb-5">
                                <div className="card bg-light border-0 h-100">
                                    <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0 intro">
                                        <div className="feature bg-primary bg-gradient text-white rounded-3 mb-4 mt-n4 img"><i className="bi bi-bootstrap" /></div>
                            ...
                            <div className="col-lg-6 col-xxl-4 mb-5">
                                <div className="card bg-light border-0 h-100">
                                    <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0 intro">
                                        <div className="feature bg-primary bg-gradient text-white rounded-3 mb-4 mt-n4 img"><i className="bi bi-code" /></div>
                            ...
                            <div className="col-lg-6 col-xxl-4 mb-5">
                                <div className="card bg-light border-0 h-100">
                                    <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0 intro">
                                        <div className="feature bg-primary bg-gradient text-white rounded-3 mb-4 mt-n4 img"><i className="bi bi-patch-check" /></div>
